...
const IconWrapper: React.FC<{ children: React.ReactNode, className?: string }> = ({ children, className }) => (
    <div className={`w-16 h-16 mb-6 inline-flex items-center justify-center rounded-full bg-primary/10 text-primary ${className}`}>
        {children}
    </div>
);
...
const SwordsIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="m15.2 3-6.4 6.4" /><path d="m21.2 8.8-6.4 6.4" /><path d="m3 14.2 6.4 6.4" /><path d="m8.8 2.8 6.4 6.4" />
    </svg>
);

const BrainCircuitIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 5a3 3 0 1 0-5.993.119A3.5 3.5 0 0 0 8.5 12.5a3 3 0 1 0 5.495 2.025A3.5 3.5 0 0 0 12.5 8.5a3 3 0 0 0-2.5-4.33A3.5 3.5 0 0 0 12 5Z" /><path d="M4.5 15.5A3.5 3.5 0 0 0 8 19c1.933 0 3.5-1.567 3.5-3.5A3.5 3.5 0 0 0 8 12" /><path d="M19.5 15.5A3.5 3.5 0 0 1 16 19c-1.933 0-3.5-1.567-3.5-3.5A3.5 3.5 0 0 1 16 12" /><path d="M12 19a3 3 0 1 0-1.5-5.657" /><path d="M12 5a3 3 0 1 1 1.5 5.657" />
    </svg>
);
    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden relative">
      ...
      >
        ...
        <header className="text-center py-28 sm:py-40">
          <motion.h1 variants={itemVariants} className="text-5xl sm:text-7xl md:text-8xl font-black tracking-tighter">
            VITAMANCER
          </motion.h1>
          <motion.h2 variants={itemVariants} className="text-2xl sm:text-3xl mt-4 text-muted-foreground font-medium">
          ...
          <motion.div variants={itemVariants} className="mt-12">
            <Button onClick={onGetStarted} size="lg" className="text-lg px-10 py-7 font-bold transform hover:scale-105 transition-transform">
        ...
        <motion.section variants={itemVariants} className="py-20">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h3 className="text-4xl font-bold">Your Life, Gamified.</h3>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <Card className="bg-secondary/30 border-border/50">
              <CardHeader>
                  <IconWrapper><SwordsIcon className="w-8 h-8" /></IconWrapper>
                  <CardTitle className="text-2xl">Forge Your Hero</CardTitle>
              </CardHeader>
            ...
            <Card className="bg-secondary/30 border-border/50">
              <CardHeader>
                  <IconWrapper><ShieldCheckIcon className="w-8 h-8" /></IconWrapper>
                  <CardTitle className="text-2xl">Conquer Quests</CardTitle>
              </CardHeader>
            ...
            <Card className="bg-secondary/30 border-border/50">
               <CardHeader>
                   <IconWrapper><BrainCircuitIcon className="w-8 h-8" /></IconWrapper>
                   <CardTitle className="text-2xl">Unlock Potential</CardTitle>
              </CardHeader>
        ...
        <motion.section initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={containerVariants} className="py-24">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <motion.div variants={itemVariants} className="md:w-1/2 text-center md:text-left">
                <h2 className="text-4xl font-bold tracking-tight mb-4">Forge Your Digital Self</h2>
            ...
            <motion.div variants={itemVariants} className="md:w-1/2">
                <div className="grid grid-cols-3 gap-4">
                    {CHARACTER_CLASSES.slice(0, 6).map((charClass, i) => (
                        <div key={i} className="p-2 bg-secondary rounded-lg border border-border/50 aspect-square flex flex-col items-center justify-center">
                            <img src={charClass.spriteUrl} alt={charClass.name} className="w-16 h-16 bg-background rounded-md" />
                            <p className="text-sm font-semibold mt-2">{charClass.name}</p>
                        </div>
                    ))}
                </div>
            </motion.div>
        ...
        <motion.section initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={containerVariants} className="py-24">
            <div className="flex flex-col md:flex-row-reverse items-center gap-12">
                <motion.div variants={itemVariants} className="md:w-1/2 text-center md:text-left">
                    <h2 className="text-4xl font-bold tracking-tight mb-4">Turn Chores into Epic Quests</h2>
                ...
                <motion.div variants={itemVariants} className="md:w-1/2">
                    <Card className="bg-card/80 backdrop-blur-sm p-4">
                        <CardHeader className="p-2"><CardTitle className="text-xl">Daily Quests</CardTitle></CardHeader>
                        <CardContent className="p-2 space-y-3">
                            <div className="flex items-center p-3 bg-secondary rounded-lg border-l-4 border-l-green-500">
                                ...
                                <span className="ml-auto font-bold text-green-400 text-sm">+10 XP</span>
                            </div>
                            <div className="flex items-center p-3 bg-secondary rounded-lg border-l-4 border-l-yellow-500">
                                ...
                                <span className="ml-auto font-bold text-yellow-400 text-sm">+25 XP</span>
                            </div>
        ...
        <motion.section initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={containerVariants} className="py-24 text-center">
            <motion.div variants={itemVariants}>
                <h2 className="text-4xl font-bold tracking-tight mb-4">Your Personal Quest Master</h2>
            ...
            <motion.div variants={itemVariants} className="mt-12 max-w-2xl mx-auto">
                 <Card className="bg-card/80 backdrop-blur-sm p-6 text-left">
                    ...
                    <div className="flex gap-2">
                        <input type="text" value="Learn a new skill" readOnly className="flex-grow h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm" />
                        <Button>Generate Quests</Button>
                    </div>
                </Card>
            </motion.div>
        </motion.section>
        ...
        <motion.section initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={containerVariants} className="py-24">
            <motion.div variants={itemVariants} className="text-center max-w-3xl mx-auto mb-16">
                <h3 className="text-4xl font-bold">Hear From Fellow Adventurers</h3>
            ...
            <div className="grid md:grid-cols-3 gap-8">
                <motion.div variants={itemVariants}>
                    <Card className="h-full bg-secondary/30 border-border/50 flex flex-col">
                      ...
                      <CardHeader className="pt-0">
                          <div className="flex items-center gap-3">
                              <img src="https://api.dicebear.com/8.x/pixel-art/svg?seed=alex" alt="Alex's avatar" className="w-12 h-12 bg-background rounded-md" />
                              <div>
                ...
                <motion.div variants={itemVariants}>
                    <Card className="h-full bg-secondary/30 border-border/50 flex flex-col">
                      ...
                      <CardHeader className="pt-0">
                          <div className="flex items-center gap-3">
                              <img src="https://api.dicebear.com/8.x/pixel-art/svg?seed=sara" alt="Sara's avatar" className="w-12 h-12 bg-background rounded-md" />
                              <div>
                                  <p className="font-semibold">Sara K.</p>
                ...
                <motion.div variants={itemVariants}>
                    <Card className="h-full bg-secondary/30 border-border/50 flex flex-col">
                      <CardContent className="p-6 flex-grow">
                       ...
                       <CardHeader className="pt-0">
                          <div className="flex items-center gap-3">
                              <img src="https://api.dicebear.com/8.x/pixel-art/svg?seed=dave" alt="Dave's avatar" className="w-12 h-12 bg-background rounded-md" />
                              <div>
                                  <p className="font-semibold">Dave R.</p>
        ...
        <motion.section initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={containerVariants} className="py-24">
            <motion.div variants={itemVariants} className="text-center max-w-3xl mx-auto mb-12">
                <h3 className="text-4xl font-bold">Your Questions, Answered</h3>
            </motion.div>
        ...
        <motion.section initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={itemVariants} className="text-center py-28">
          <h2 className="text-4xl sm:text-5xl font-bold tracking-tight">Ready to Begin Your Epic Journey?</h2>
