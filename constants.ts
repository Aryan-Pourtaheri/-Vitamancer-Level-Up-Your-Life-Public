...
export const CHARACTER_CLASSES: CharacterClass[] = [
  {
    ...
    avatar: { skinColor: '#c09f8e', hairColor: '#4a312c', hairStyle: 'spiky', outfitColor: '#8B0000', accentColor: '#FFD700', eyeStyle: 'angry' },
  },
  {
    name: 'Mage',
    description: 'A wielder of powerful magic, with high intelligence.',
    avatar: { skinColor: '#d5a38a', hairColor: '#ffffff', hairStyle: 'long', outfitColor: '#483D8B', accentColor: '#AFEEEE', eyeStyle: 'normal' },
  },
  {
    name: 'Rogue',
    description: 'A swift and cunning fighter, specializing in speed.',
    avatar: { skinColor: '#e8b3a5', hairColor: '#2c222b', hairStyle: 'short', outfitColor: '#2F4F4F', accentColor: '#708090', eyeStyle: 'sleepy' },
  },
  {
    name: 'Cleric',
    description: 'A divine agent who heals allies and smites foes.',
    avatar: { skinColor: '#f2d3b1', hairColor: '#e5cc28', hairStyle: 'bun', outfitColor: '#F5F5DC', accentColor: '#DAA520', eyeStyle: 'happy' },
  },
  {
    name: 'Archer',
    description: 'A marksman with unparalleled accuracy and speed.',
    avatar: { skinColor: '#d3a089', hairColor: '#b0632b', hairStyle: 'mohawk', outfitColor: '#006400', accentColor: '#CD853F', eyeStyle: 'normal' },
  },
  {
    name: 'Paladin',
    description: 'A holy knight bound by an oath to protect the innocent.',
    avatar: { skinColor: '#c09f8e', hairColor: '#cb7a36', hairStyle: 'short', outfitColor: '#E6E6FA', accentColor: '#FFD700', eyeStyle: 'normal' },
  },
];
